...
try {
  ...
  const tests = spawn(process.execPath, ['--test', 'src/render-home.browser.test.ts', 'src/render-walk.browser.test.ts', 'src/render-traffic.browser.test.ts', 'src/render-documents.browser.test.ts', '404.browser.test.ts'], { stdio: 'inherit' })
